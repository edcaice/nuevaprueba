<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Phonegap.Tour_Virtuales.Parques.Index" %>
...
<html lang="en">
<head>
<title>Cookhouse a Mobile App Flat Bootstrap Responsive Website Template | Home :: W3layouts</title> 
...
<body>
	<div class="main-row">
		...
		<div class="main_frame w3layouts_frame">
			<iframe class="frame-border scroll-pane" src="main.aspx" frameborder="0"></iframe>
		</div>
	</div>
	<div class="agileinfo_copy_right">
		<p>&copy; 2016 Cookhouse. All Rights Reserved | Design by <a href="http://w3layouts.com" target="_blank">W3layouts</a></p>
	</div>
</body>
</html>
