...
<body>
    ...
    <!-- Brand and toggle get grouped for better mobile display -->
					...
					<div class="">
						<h1 class="text-center"> Ibarra Móvil</h1>
                           </div> 
...
<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li><a href="">Hoteles <span class="sr-only">(current)</span></a></li>
								<li><a href="Restaurantes/MRestaurante.aspx" class="scroll">Restaurantes</a></li>
								<li><a href="" class="scroll">Huecas</a></li>
								<li><a href="Tour Virtuales/MTourVirtual.aspx" >Lugares Turisticos</a></li>
                ...
                <ul class="rslides" id="slider">          
                        <img src="images/3.jpg" class="banner-section">        
                    </ul>
                           </div>
					</div>
			</div>
