<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MRestaurante.aspx.cs" Inherits="Phonegap.Restaurantes.MRestaurante" %>
...
<body>
  ...
  <ul id="main-menu" class="top-nav menu clearfix">
    <li class="menu-item">
      <a href="RestauranteLujo/Lujo.aspx">De Lujo</a>
    </li>
    <li class="menu-item">
      <a href="http://codepen.io">Primera Categoria</a>
    </li>
    <li class="menu-item">
      <a href="http://codepen.io">Segunda Categoria</a>
    </li>
    <%--<li class="menu-item">
