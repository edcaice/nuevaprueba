<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lujo.aspx.cs" Inherits="Phonegap.Restaurantes.RestauranteLujo.Lujo" %>
...
<body>
  ...
  <ul id="main-menu" class="top-nav menu clearfix">
    <li class="menu-item">
      <a href="http://codepen.io">La Estelita</a>
    </li>
    <li class="menu-item">
      <a href="http://codepen.io">Quinta San Andres</a>
    </li>
    <li class="menu-item">
      <a href="http://codepen.io">Ajavi</a>
    </li>
    <%--<li class="menu-item">
